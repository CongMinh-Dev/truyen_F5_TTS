...
Mục tiêu: Đảm bảo bộ vocab bao phủ đầy đủ token của Tiếng Việt.
    kiểm tra file vocab trong dataset mới xem có ký tự nào không nằm trong file vocab mẫu không.
    nếu có thì tạo một vocab mới bao gồm vocab mẫu+ký tự còn thiếu. và lưu theo đường dẫn OUTPUT_VOCAB_PATH
"""

import os

# Định nghĩa đường dẫn file vocab
PRETRAINED_VOCAB_PATH = "data/Emilia_ZH_EN_pinyin/vocab.txt" # path đến file vocab mẫu
DATASET_VOCAB_PATH = "data/your_training_dataset/vocab_your_dataset.txt" #path đến file vocab của mình 
OUTPUT_VOCAB_PATH = "data/your_training_dataset/vocab.txt" #path để lưu file vocab mới 

...
Chỉ lấy các file âm thanh từ 1 giây đến 30 giây
Chỉ lấy các câu có ít nhất 3 từ.
Tự động chuyển văn bản về chữ thường (lower) và xóa các khoảng trắng thừa hoặc ký tự gạch dưới (_).
Tự động trích xuất Vocab để sử dụng cho bước tiếp theo trong fine_tuning.sh (check_vocab_pretrained.py)
đọc trong file world để biết chi tiết hơn
"""
...
# Đường dẫn dữ liệu
DATASET_DIR = "data/your_dataset" #path input
TRAINING_DIR = "data/your_training_dataset" #path outpput
